...
function IM_unwrapped = GoldsteinUnwrap2D(IM_phase, IM_mag, handles)
...
branch_cuts=BranchCuts(residue_charge, max_box_radius, IM_mask, handles);            %Place branch cuts
[IM_unwrapped, rowref, colref]=FloodFill(IM_phase, branch_cuts, IM_mask, handles);   %Flood fill phase unwrapping
